...
function showWeatherReport(weather){
    ...
    {
        if(weatherType.textContent == 'Clouds'||weatherType.textContent == 'Mostly Cloudy'||weatherType.textContent == 'Intermittent Clouds'){
            document.body.style.backgroundImage="url('icons/cloudyn.jpg')";
           
        }
        else  if(weatherType.textContent == 'Clear' || weatherType.textContent=='Mostly Clear'){
            document.body.style.backgroundImage="url('icons/clearn.jpg')";
        }
        else  if(weatherType.textContent == 'Rain' || weatherType.textContent == 'Showers'){
            document.body.style.backgroundImage="url('icons/rainn.jpg')";
        }
        else  if(weatherType.textContent == 'Snow'){
            document.body.style.backgroundImage="url('icons/snown.jpg')";
        }
        else  if(weatherType.textContent == 'Thunderstorm'){
            document.body.style.backgroundImage="url('icons/thundern.jpg')";
        }
            ...
            document.body.style.backgroundImage="url('icons/fogn.jpeg')";
        }
        else  if(weatherType.textContent == 'Windy'){
            document.body.style.backgroundImage="url('icons/windn.jpg')";
        }
    }
